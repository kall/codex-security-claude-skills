# Claude 로컬 보안 스킬 (codex-security-local-skills)
...
```bash
BASE=https://github.com/kall/codex-security-local-skills/releases/latest/download
...
```bash
git clone https://github.com/kall/codex-security-local-skills
cd codex-security-local-skills
